...
const ShapeHandles: React.FC<ShapeHandlesProps> = memo(
    ({
        ...
        return (
            ...
            >
                {/* Show handles only if NOT hidden and IS selected (or always if logic dictates, but handles usually require selection) */}
                {/* Wait, handles normally show only when selected via CSS? */}
